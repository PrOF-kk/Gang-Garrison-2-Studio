// Returns true if the game is successfully initialized, false if there was an error and we should quit.
{
    ...
    fct_set_little_endian_global(true);
    ...
    global.MenuMusic = -1;//sound_add(choose("Music/menumusic1.wav","Music/menumusic2.wav","Music/menumusic3.wav","Music/menumusic4.wav","Music/menumusic5.wav","Music/menumusic6.wav"), 1, true);
    global.IngameMusic = -1;//sound_add("Music/ingamemusic.wav", 1, true);
    global.FaucetMusic = -1;//sound_add("Music/faucetmusic.wav", 1, true);
